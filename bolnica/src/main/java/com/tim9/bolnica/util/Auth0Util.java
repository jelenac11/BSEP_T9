...
public class Auth0Util {
	...
	public static void getManagementApiToken() {
		...
		HashMap<String, String> result = restTemplate.postForObject("https://dev-lsmn3kc2.eu.auth0.com/oauth/token",
	...
	public static String getAdminHospital() {
		...
		ResponseEntity<String> result = restTemplate.exchange(
				"https://dev-lsmn3kc2.eu.auth0.com/api/v2/users/" + user + "?fields=user_metadata", HttpMethod.GET,
				entity, String.class);
		try {
